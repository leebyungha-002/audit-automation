...
def build():
    ...
    # 예시행: 유형자산(정액법/정률법/손상차손), 투자부동산, 무형자산 각 케이스
    examples = [
        [
        ...
        [
            ...
            "정액법", None, "당월", None, None, None, None, None, "영업외비용", "예시 행 — 실제 자산으로 교체",
        ],
        [
            "제2공장", "무형자산", "FA-0005", "소프트웨어", "예시) ERP 라이선스", "2022-01-01", 60000000, 0, 5,
            "정액법", None, "당월", None, None, None, None, None, "판관", "예시 행 — 실제 자산으로 교체",
        ],
    ]
