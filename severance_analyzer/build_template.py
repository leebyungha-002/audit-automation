...
def build():
    ...
    # 예시행: 기존재직자(제조/판관, 상여금 있는 경우 포함), 당기 신규입사자, 중간정산 이력자
    examples = [
        [
            "본사", "생산1팀", "EMP-1001", "예시)홍길동", "과장",
            "제조원가", "2019-03-02", None,
            4200000, 6000000, "예시 행 — 실제 인원으로 교체(기존 재직자, 연간상여금 600만원 지급)",
        ],
        [
            "본사", "경영지원팀", "EMP-1002", "예시)김영희", "대리",
            "판관비", "2021-11-15", None,
            3800000, 0, "예시 행 — 기존 재직자(상여금 없음)",
        ],
        [
            "본사", "영업팀", "EMP-1003", "예시)이철수", "사원",
            "판관비", "2026-04-01", None,
            3200000, 0, "예시) 당기 중 신규입사 — 전기 인원명단에는 없어 요약표의 '신규입사자 명단'에 자동 표시됨",
        ],
        [
